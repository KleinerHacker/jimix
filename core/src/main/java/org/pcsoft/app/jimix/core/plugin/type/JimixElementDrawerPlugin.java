...
public final class JimixElementDrawerPlugin implements JimixPlugin<JimixElementDrawerInstance> {
    ...
    public Image draw(final JimixElementModel elementModel) throws JimixPluginExecutionException {
        ...
        try {
            resultImage = instance.draw(elementModel);
        } catch (Exception e) {
    ...
    public Class<? extends JimixElementModel> getElementModelClass() {
