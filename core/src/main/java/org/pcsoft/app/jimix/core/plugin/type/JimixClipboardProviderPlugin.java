...
public final class JimixClipboardProviderPlugin implements JimixPlugin<JimixClipboardProviderInstance> {
    ...
    /**
     * <b>Use always with {@link org.pcsoft.app.jimix.core.project.ProjectManager#createElementFromClipboardForLayer(JimixLayer, JimixClipboardProviderPlugin)}</b>
     * @param clipboard
     * @return
     */
    JimixElementModel createElementFromClipboard(Clipboard clipboard) {
