...
public final class TextPluginElementUtils {
    public static Shape buildShape(int x, int y, TextPluginElement element) {
        return buildShape(x, y, element, null, null);
    }

    public static Shape buildShape(int x, int y, TextPluginElement element, String txt, Double size) {
