...
@JimixBlenderDescriptor(name = "Lighten", description = "Lighting algorithm", group = "Calculation",
        iconPath = "/builtin/icons/ic_blender_subtract16.png")
public class LightenBlender implements JimixBlender {
    @Override
