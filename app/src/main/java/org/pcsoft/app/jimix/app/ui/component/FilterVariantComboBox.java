...
public class FilterVariantComboBox extends ComboBoxEx<JimixFilterVariant, String> {
    ...
    public FilterVariantComboBox() {
        ...
        setValueComparator(Comparator.comparing(JimixFilterVariant::getName));
        setValueCellRendererCallback(this::drawValue);
        setValueButtonCellRendererCallback(this::drawValue);
    }

    private void drawValue(ListCell listCell, JimixFilterVariant variant, boolean empty) {
