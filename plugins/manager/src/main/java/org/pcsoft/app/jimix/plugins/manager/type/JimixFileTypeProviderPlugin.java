...
public final class JimixFileTypeProviderPlugin implements JimixPlugin<JimixFileTypeProviderInstance> {
    private static final Logger LOGGER = LoggerFactory.getLogger(JimixFileTypeProviderPlugin.class);
    ...
    public JimixFileTypeProviderPlugin(JimixFileTypeProvider instance) throws JimixPluginException {
    ...
    @Override
    public JimixFileTypeProviderInstance createInstance() throws JimixPluginException {
        return new JimixFileTypeProviderInstance(this);
    }
