...
public final class JimixImageFileTypeProviderPlugin implements JimixPlugin<JimixImageFileTypeProviderInstance> {
    private static final Logger LOGGER = LoggerFactory.getLogger(JimixImageFileTypeProviderPlugin.class);
    private static final StopWatch STOP_WATCH = new StopWatch();

    private final JimixImageFileTypeProvider instance;
    private final JimixFileTypeProviderDescriptor descriptor;
    private final ResourceBundle resourceBundle;

    public JimixImageFileTypeProviderPlugin(JimixImageFileTypeProvider instance) throws JimixPluginException {
    ...
    void save(Image image, File file) throws IOException {
    ...
    @Override
    public JimixImageFileTypeProviderInstance createInstance() throws JimixPluginException {
        return new JimixImageFileTypeProviderInstance(this);
    }
