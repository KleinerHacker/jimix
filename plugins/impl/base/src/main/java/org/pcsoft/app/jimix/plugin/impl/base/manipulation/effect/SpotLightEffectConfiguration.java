...
public class SpotLightEffectConfiguration implements JimixEffectConfiguration<SpotLightEffectConfiguration> {
    ...
    @JimixProperty(fieldType = Double.class, name = "Specular Exponent", description = "Specular Exponent", category = "Light")
    @JimixPropertyDoubleRestriction(minValue = 0.5d, maxValue = 2d)
    private final DoubleProperty specularExponent = new SimpleDoubleProperty(100d);
    ...
    public double getSpecularExponent() {
        return specularExponent.get();
    }

    public DoubleProperty specularExponentProperty() {
        return specularExponent;
    }

    public void setSpecularExponent(double specularExponent) {
        this.specularExponent.set(specularExponent);
    }
    ...
    public Observable[] getObservables() {
        return new Observable[] {
                x, y, z, specularExponent, color
        };
    }

    @Override
    public void update(SpotLightEffectConfiguration newConfiguration) {
        this.x.set(newConfiguration.x.get());
        this.y.set(newConfiguration.y.get());
        this.z.set(newConfiguration.z.get());
        this.specularExponent.set(newConfiguration.specularExponent.get());
        this.color.set(newConfiguration.color.get());
    }

    @Override
    public SpotLightEffectConfiguration copy() {
        final SpotLightEffectConfiguration configuration = new SpotLightEffectConfiguration();
        configuration.x.set(this.x.get());
        configuration.y.set(this.y.get());
        configuration.z.set(this.z.get());
        configuration.specularExponent.set(this.specularExponent.get());
    ...
    public void save(ObjectOutputStream out) throws IOException {
        ...
        out.writeDouble(this.specularExponent.get());
    ...
    public void load(ObjectInputStream in) throws IOException {
        ...
        this.specularExponent.set(in.readDouble());
