...
public class InnerShadowEffectConfiguration implements JimixEffectConfiguration<InnerShadowEffectConfiguration> {
    ...
    @Override
    public void update(InnerShadowEffectConfiguration configuration) {
    ...
    @Override
    public InnerShadowEffectConfiguration copy() {
        final InnerShadowEffectConfiguration configuration = new InnerShadowEffectConfiguration();
